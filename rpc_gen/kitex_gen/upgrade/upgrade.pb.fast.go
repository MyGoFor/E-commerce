...
func (x *UpgradeReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
...
func (x *UpgradeReq) fastWriteField3(buf []byte) (offset int) {
	if x.Content == "" {
		return offset
	}
...
func (x *UpgradeReq) sizeField3() (n int) {
	if x.Content == "" {
		return n
	}
